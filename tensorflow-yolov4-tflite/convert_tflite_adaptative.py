...
def save_tflite():
    ...
    # Habilita las operaciones de TensorFlow (TF Select) para incluir 'FusedBatchNormV3'
    converter.target_spec.supported_ops = [
        tf.lite.OpsSet.TFLITE_BUILTINS,
        tf.lite.OpsSet.SELECT_TF_OPS  # Esto habilita flex ops como FusedBatchNormV3
    ]
    converter.allow_custom_ops = True

    # Configura la cuantización si es necesario
